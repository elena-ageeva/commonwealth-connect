    ...
    <FilterStyles>
      ...
      >
        <div className="filter__sections">
          ...
          ></FilterSection>
          <FilterSection
            title="Size of Practice"
            children={[
              <Number key="number1" label="Minimum advisors in office" />,
              <Number key="number2" label="Minimum staff in office" />
            ]}
          ></FilterSection>
          ...
          <FilterSection
            ...
            type="checkbox list"
            children={[
              <Checkbox key="checkbox 1" label="Up to $200,000" />,
              ...
              <Checkbox key="checkbox 6" label="$1,500,000+" />
            ]}
          ></FilterSection>
        </div>
      </Scrollbars>
